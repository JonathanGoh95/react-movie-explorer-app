    ...
    return(
        ...
        <div class="flex flex-col gap-5 items-center justify-center p-6 border-2 w-1/2">
            {/* <div class="p-4 rounded shadow max-w-lg w-full relative"> */}
                ...
                <img src={selectedMovie.Poster} alt={selectedMovie.Title} class="mb-3" />
                <p><strong>Genre(s):</strong> {selectedMovie.Genre}</p>
                <p><strong>IMDb Rating:</strong> {selectedMovie.imdbRating} ⭐</p>
                <p><strong>Plot:</strong> {selectedMovie.Plot}</p>
                <button class='font-bold bg-white border-2 rounded-md pt-1 pb-1 pl-3 pr-3' onClick={handleClick}>Back</button>
            {/* </div> */}
        </div>}
        </div>
    )
